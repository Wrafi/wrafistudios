      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'Portfolio')
              : PortfolioWidget(),
        ),
        FFRoute(
          name: 'AboutMe',
          path: '/aboutMe',
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'AboutMe')
              : AboutMeWidget(),
        ),
        FFRoute(
          name: 'profile',
        ...
        FFRoute(
          ...
          asyncParams: {
            'portfolioDetails':
                getDoc(['portfolio'], PortfolioRecord.fromSnapshot),
          },
          builder: (context, params) => PortfolioDetailsWidget(
            portfolioDetails:
                params.getParam('portfolioDetails', ParamType.Document),
          ),
        ),
        FFRoute(
          name: 'editProfile',
        ...
        FFRoute(
          name: 'successRequest',
          path: '/successRequest',
          builder: (context, params) => SuccessRequestWidget(),
        ),
        FFRoute(
          name: 'resetPassword',
          path: '/resetPassword',
        ...
        FFRoute(
          name: 'addPortfolio',
          path: '/addPortfolio',
          builder: (context, params) => AddPortfolioWidget(),
        ),
        FFRoute(
          name: 'editPortfolio',
          path: '/editPortfolio',
          asyncParams: {
            'document': getDoc(['portfolio'], PortfolioRecord.fromSnapshot),
          },
        ...
        FFRoute(
          name: 'UserRequests',
          path: '/userRequests',
          builder: (context, params) => UserRequestsWidget(),
        ),
        FFRoute(
          name: 'RequestDetails',
          path: '/requestDetails',
