                                        ...
                                        Align(
                                          ...
                                          child: StreamBuilder<
                                            ...
                                            builder: (context, snapshot) {
                                              ...
                                              List<PortfolioRecord>
                                                  textPortfolioRecordList =
                                                  snapshot.data!;
                                              return Text(
                                                textPortfolioRecordList.length
                                                    .toString(),
                                                style:
                                                    FlutterFlowTheme.of(context)
                                                        .displaySmall
                    ...
                    Expanded(
                      child: TabBarView(
                        ...
                        children: [
                          ...
                          Stack(
                            children: [
                              StreamBuilder<List<PortfolioRecord>>(
                                stream: queryPortfolioRecord(),
                                builder: (context, snapshot) {
                                  // Customize what your widget looks like when it's loading.
                                  if (!snapshot.hasData) {
                                  ...
                                  return ListView.builder(
                                    ...
                                    scrollDirection: Axis.vertical,
                                    itemCount:
                                        listViewPortfolioRecordList.length,
                                    itemBuilder: (context, listViewIndex) {
                              ...
                              return ListView.builder(
                                ...
                                itemBuilder: (context, listViewIndex) {
                                  ...
                                  return InkWell(
                                    ...
                                    child: ListTile(
                                      title: Text(
                                        listViewRequestsRecord.projectName,
                                        style: FlutterFlowTheme.of(context)
                                            .titleLarge,
                                      ),
                                      subtitle: Text(
                                        listViewRequestsRecord.details,
                                        style: FlutterFlowTheme.of(context)
                                            .labelMedium,
                                      ),
                                      trailing: Icon(
